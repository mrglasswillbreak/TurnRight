...
export default defineConfig({
  ...
  grep: /phone survey|motion assistance|drawing session.*touch|public phone|editor reliability|building appearance phone|building references phone|view settings phone|enhanced zoom restores|readable interface dark phone|roof batch phone|slate map.*phone|model workspace touch layouts|landscape model has reachable/,
  use: {
    ...base.use,
    browserName: 'webkit',
    hasTouch: true,

      ...
      {!navigating ? (
        <>
            ...
            <label>
              ...
              >
                ...
                {data.places
                  .filter(
                    (p) =>
                      placeHasConnection(data, p) && p.id !== destination.id,
                  )
                  .map((p) => (
          ...
          {routes.map((r, index) => (
            ...
            >
              ...
              <p>
                {index === 0 ? 'Shortest mapped walk' : `Alternative ${index}`}
              </p>
        ...
        <>
          ...
          <div className="journey-stats">
            <div>
              <strong>
                {minutes(Math.max(0, route.seconds - nav.progress / 1.25))}
              </strong>
              <span>remaining</span>
            </div>
            <div>
            ...
            <div>
              <strong>
                {new Date(
                  Date.now() +
                    Math.max(0, route.seconds - nav.progress / 1.25) * 1000,
                ).toLocaleTimeString([], {
                  hour: '2-digit',
                  minute: '2-digit',
                })}

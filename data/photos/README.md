...
Reviewed 23 September 2026 against published map **lasu-a81135d18314**.
...
| Distinct release photographs | 0 | 22 |
| Photograph download bytes | 0 | 4,468,572 (4.26 MiB) |
...
All 22 included images have original Commons author/source records and **CC BY-SA
...
XMP or ICC data. All 22 files are included offline; there is no count limit.
...
then edit `decisions.json`. The collector stops on incomplete downloads, changed
